...
With the permission codes, you can use the `AccessControl` component and API provided by `@web/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@web/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@web/access';
</script>
...
```vue
<script lang="ts" setup>
import { useAccess } from '@web/access';
