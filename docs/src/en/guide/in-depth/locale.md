...
import { updatePreferences } from '@web/preferences';
...
- Do not place business translation texts inside `@web/locales` to better manage business and general translation texts.
...
With `@web/locales`, you can easily use translation texts:
