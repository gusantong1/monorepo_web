...
- The icons in the project are mainly provided by the `@web/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { createIconifyIcon } from '@web-core/icons';
...
import { MdiKeyboardEsc } from '@web/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@web/icons';
</script>
