...
```json
{
  "scripts": {
    ...
    "build:naive": "pnpm run build --filter=@web/naive",
...
Take the addition of the test environment `test` to `@web/web-antd` as an example:
...
"scripts": {
    ...
    "build:analyze": "turbo build:analyze",
    "build:antd": "pnpm run build --filter=@web/web-antd",
    "build-test:antd": "pnpm run build --filter=@web/web-antd build:test",
...
"tasks": {
    ...
    "build-test:antd": {
      "dependsOn": ["@web/web-antd#build:test"],
      "outputs": ["dist/**"]
    },

    "@web/web-antd#build:test": {
      "dependsOn": ["^build"],
      "outputs": ["dist/**"]
    },
