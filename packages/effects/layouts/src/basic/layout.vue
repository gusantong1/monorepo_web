...
import { $t, i18n } from '@web/locales';
import {
  preferences,
  updatePreferences,
  usePreferences,
...
import { cloneDeep, mapTree } from '@web/utils';

import { VbenAdminLayout } from '@web-core/layout-ui';
import { VbenBackTop, VbenLogo } from '@web-core/shadcn-ui';
