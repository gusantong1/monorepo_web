...
import { LockKeyhole } from '@web/icons';
import { $t, useI18n } from '@web/locales';
import { storeToRefs, useAccessStore } from '@web/stores';

import { useScrollLock } from '@web-core/composables';
import { useVbenForm, z } from '@web-core/form-ui';
import { VbenAvatar, VbenButton } from '@web-core/shadcn-ui';
