...
import type { MenuRecordRaw } from '@web/types';

import { nextTick, onMounted, ref, shallowRef, watch } from 'vue';
import { useRouter } from 'vue-router';

import { SearchX, X } from '@web/icons';
import { $t } from '@web/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@web/utils';

import { VbenIcon, VbenScrollbar } from '@web-core/shadcn-ui';
import { isHttpUrl } from '@web-core/shared/utils';
